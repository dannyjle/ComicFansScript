...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { creator: @comic.creator, name: @comic.name, number: @comic.number, publisher: @comic.publisher, volume: @comic.volume } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { creator: @comic.creator, name: @comic.name, number: @comic.number, publisher: @comic.publisher, volume: @comic.volume } }
